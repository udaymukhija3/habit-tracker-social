...
public class FriendshipController {
    ...
    public ResponseEntity<Friendship> acceptFriendRequest(@PathVariable Long friendshipId, Authentication authentication) {
        User currentUser = (User) authentication.getPrincipal();
    ...
    public ResponseEntity<Friendship> declineFriendRequest(@PathVariable Long friendshipId, Authentication authentication) {
        User currentUser = (User) authentication.getPrincipal();
